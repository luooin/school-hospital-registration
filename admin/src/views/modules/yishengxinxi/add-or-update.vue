<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="挂号须知" prop="guahaoxuzhi">
          <el-input v-model="ruleForm.guahaoxuzhi" 
              placeholder="挂号须知" clearable  :readonly="ro.guahaoxuzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="挂号须知" prop="guahaoxuzhi">
              <el-input v-model="ruleForm.guahaoxuzhi" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="就医流程" prop="jiuyiliucheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="就医流程"
                  v-model="ruleForm.jiuyiliucheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiuyiliucheng" label="就医流程" prop="jiuyiliucheng">
                    <span>{{ruleForm.jiuyiliucheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yishengxingming = true;
          ...
          if(o=='guahaoxuzhi'){
            this.ruleForm.guahaoxuzhi = obj[o];
	    this.ro.guahaoxuzhi = true;
            continue;
          }
          if(o=='keshi'){
	    ...
	    this.ro.guahaofei = true;
          ...
          if(o=='jiuyiliucheng'){
            this.ruleForm.jiuyiliucheng = obj[o];
	    this.ro.jiuyiliucheng = true;
            continue;
          }
          if(o=='lianxidianhua'){
	...
	this.ruleForm.jianjie = this.ruleForm.jianjie.replace(reg,'../../../hospitalRegistration/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
