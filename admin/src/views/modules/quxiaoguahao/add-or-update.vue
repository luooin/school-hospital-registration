<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原因" prop="yuanyin">
          <el-input v-model="ruleForm.yuanyin" 
              placeholder="原因" clearable  :readonly="ro.yuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="原因" prop="yuanyin">
              <el-input v-model="ruleForm.yuanyin" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='yuanyin'){
            this.ruleForm.yuanyin = obj[o];
	    this.ro.yuanyin = true;
            continue;
          }
          if(o=='quxiaoshijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `quxiaoguahao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.quxiaoguahaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
