...
public class QuxiaoguahaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,QuxiaoguahaoEntity quxiaoguahao,
		...
		if(tableName.equals("yisheng")) {
			quxiaoguahao.setYishenggonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<QuxiaoguahaoEntity> wrapper = new EntityWrapper<QuxiaoguahaoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = quxiaoguahaoService.selectCount(wrapper);
