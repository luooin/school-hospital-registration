<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="英文名称" prop="yingwenmingcheng">
          <el-input v-model="ruleForm.yingwenmingcheng" 
              placeholder="英文名称" clearable  :readonly="ro.yingwenmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="英文名称" prop="yingwenmingcheng">
              <el-input v-model="ruleForm.yingwenmingcheng" 
                placeholder="英文名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="厂商名称" prop="changshangmingcheng">
          <el-input v-model="ruleForm.changshangmingcheng" 
              placeholder="厂商名称" clearable  :readonly="ro.changshangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="厂商名称" prop="changshangmingcheng">
              <el-input v-model="ruleForm.changshangmingcheng" 
                placeholder="厂商名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="厂商地址" prop="changshangdizhi">
          <el-input v-model="ruleForm.changshangdizhi" 
              placeholder="厂商地址" clearable  :readonly="ro.changshangdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="厂商地址" prop="changshangdizhi">
              <el-input v-model="ruleForm.changshangdizhi" 
                placeholder="厂商地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yaopintupian" label="药品图片" prop="yaopintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yaopintupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品价格" prop="yaopinjiage">
          <el-input v-model="ruleForm.yaopinjiage" 
              placeholder="药品价格" clearable  :readonly="ro.yaopinjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品价格" prop="yaopinjiage">
              <el-input v-model="ruleForm.yaopinjiage" 
                placeholder="药品价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	yingwenmingcheng : false,
	jixing : false,
	yaopinleibie : false,
	pinpai : false,
	changshangmingcheng : false,
	shengchanriqi : false,
	changshangdizhi : false,
	yaopintupian : false,
	yaopinjiage : false,
	shuliang : false,
	jiliangdanwei : false,
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinmingcheng = true;
          ...
          if(o=='yingwenmingcheng'){
            this.ruleForm.yingwenmingcheng = obj[o];
	    this.ro.yingwenmingcheng = true;
            continue;
          }
          if(o=='jixing'){
	    ...
	    this.ro.shengchanriqi = true;
          ...
          if(o=='changshangdizhi'){
            this.ruleForm.changshangdizhi = obj[o];
	    this.ro.changshangdizhi = true;
            continue;
          }
          if(o=='yaopintupian'){
