<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病床数" prop="bingchuangshu">
          <el-input v-model="ruleForm.bingchuangshu" 
              placeholder="病床数" clearable  :readonly="ro.bingchuangshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病床数" prop="bingchuangshu">
              <el-input v-model="ruleForm.bingchuangshu" 
                placeholder="病床数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病房位置" prop="bingfangweizhi">
          <el-input v-model="ruleForm.bingfangweizhi" 
              placeholder="病房位置" clearable  :readonly="ro.bingfangweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病房位置" prop="bingfangweizhi">
              <el-input v-model="ruleForm.bingfangweizhi" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bingfanghao = true;
          ...
          if(o=='bingchuangshu'){
            this.ruleForm.bingchuangshu = obj[o];
	    this.ro.bingchuangshu = true;
            continue;
          }
          if(o=='bingfangweizhi'){
            this.ruleForm.bingfangweizhi = obj[o];
	    this.ro.bingfangweizhi = true;
            continue;
          }
