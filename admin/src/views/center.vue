     ...
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="姓名" prop="xingming">
          <span>姓名</span>
          <el-input v-model="ruleForm.xingming"   clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='yisheng'"  label="选择性别" prop="xingbie">
          <el-select class="vv1" v-model="ruleForm.xingbie">
            <el-option
