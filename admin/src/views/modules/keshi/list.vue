        ...
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '科室' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.keshi" placeholder="科室" clearable></el-input>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if=" isAuth('keshi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if=" isAuth('keshi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if=" isAuth('keshi','修改') && contents.tableBtnIcon == 0" type="primary" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>


              <el-button v-if="isAuth('keshi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                         type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button v-if="isAuth('keshi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('keshi','删除') && contents.tableBtnIcon == 0" type="danger" size="mini"
  ...
  data() {
    return {
      ...
      contents: {
        ...
        "searchBtnBgColor": "rgba(22, 191, 195, 1)",
        "inputTitleSize": "14px",
        "btnAdAllBorderColor": "rgba(24, 170, 173, 1)",
        "pageJumper": false,
        ...
        "box": {
          ...
          "flag": "2",
          "backgroundImage": "http://codegen.caihongy.cn/20211127/2b9991fb4d11451ab088ea8e6f78a20b.png",
          "background": "rgb(255,249,249,1)"
        },
        "inputBorderWidth": "3px",
        "inputFontPosition": "2",
        "inputFontColor": "rgba(255, 255, 255, 1)",
        "pageEachNum": 10,
        "tableHeaderBgColor": "rgba(22, 191, 195, 1)",
        "inputTitleColor": "#333",
        "btnAdAllBoxPosition": "1",
        "tableBtnDetailBgColor": "rgba(22, 191, 195, 1)",
        "inputIcon": "0",
        "searchBtnIconPosition": "1",
        "btnAdAllFontSize": "14px",
        "inputBorderStyle": "outset ",
        "tableHoverFontColor": "#333",
        "inputBgColor": "rgba(22, 191, 195, 1)",
        "pageStyle": true,
        "pageTotal": false,
